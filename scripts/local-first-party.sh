...
LOCAL_CORE_PACKAGE="${WORKSPACE_PARENT}/core"
LOCAL_GLOBALS_PACKAGE="${WORKSPACE_PARENT}/globals"
LOCAL_DOTNET_PACKAGE="${WORKSPACE_PARENT}/dotnet/versions/10"
LOCAL_JS_SOURCE_PACKAGE="${WORKSPACE_PARENT}/js"
LOCAL_NODEJS_SOURCE_PACKAGE="${WORKSPACE_PARENT}/nodejs"
